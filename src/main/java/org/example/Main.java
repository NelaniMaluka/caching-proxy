...
public class Main {
    public static void main(String[] args) {
        ...
        CompletableFuture<ApiResponse> r5 = proxy.getDataAsync("https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf");
        CompletableFuture<ApiResponse> r6 = proxy.getDataAsync("https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf");
